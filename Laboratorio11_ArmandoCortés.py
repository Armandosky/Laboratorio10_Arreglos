# -*- coding: utf-8 -*-
"""
Created on Thu Apr 16 21:53:41 2020
...
def temperaturariohacha():#Temperatura en la ciudad de Riohacha en el 2020
    temperatura = np.array([
        [25,25,26,27,27,27,27,27,28,27,27,26],#Temperatura por la mañana a las 6 am
        [31,32,32,32,33,34,34,34,34,33,32,32],#Temperatura al medio dia
        [29,29,29,30,30,31,31,30,30,29,29,29]])#Temperatura por la noche a las 6 pm
    return temperatura
